...
var _sc_nz$elm_hangman$Chalk$withColorChar = F3(
...
var _sc_nz$elm_hangman$Chalk$encode = function (_p0) {
	var _p1 = _p0;
...
var _sc_nz$elm_hangman$Chalk$Chalk = F2(
	function (a, b) {
		return {styles: a, text: b};
	});

var _sc_nz$elm_hangman$Messages$Guess = function (a) {
	return {ctor: 'Guess', _0: a};
};
var _sc_nz$elm_hangman$Messages$NewWord = function (a) {
...
var _sc_nz$elm_hangman$Native_RunTest = function()
{
    return {
...
var _sc_nz$elm_hangman$Test_Reporter_TestResults$TestResult = F3(
	function (a, b, c) {
		return {labels: a, expectations: b, duration: c};
	});
var _sc_nz$elm_hangman$Test_Reporter_TestResults$Failure = F2(
	function (a, b) {
		return {given: a, message: b};
	});

var _sc_nz$elm_hangman$Test_Reporter_Chalk$stat = F2(
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$getTodosAndFailuresHelp = F2(
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$getTodosAndFailures = _sc_nz$elm_hangman$Test_Reporter_Chalk$getTodosAndFailuresHelp(
	{
		todos: {ctor: '[]'},
		nonTodoFailures: 0
	});
var _sc_nz$elm_hangman$Test_Reporter_Chalk$getNonTodoFailure = function (expectation) {
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$chalkWith = function (chalks) {
	return _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, _sc_nz$elm_hangman$Chalk$encode, chalks));
};
var _sc_nz$elm_hangman$Test_Reporter_Chalk$failureLabelsToChalk = A2(
	_elm_community$elm_test$Test_Runner$formatLabels,
	A2(
		_sc_nz$elm_hangman$Chalk$withColorChar,
	...
	A2(
		...
		_elm_lang$core$Native_Utils.chr('✗'),
		'red'));
var _sc_nz$elm_hangman$Test_Reporter_Chalk$todoToChalk = function (_p2) {
	var _p3 = _p2;
	return {
		ctor: '::',
		_0: {
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$todoLabelsToChalk = A2(
	_elm_community$elm_test$Test_Runner$formatLabels,
	A2(
		_sc_nz$elm_hangman$Chalk$withColorChar,
		_elm_lang$core$Native_Utils.chr('↓'),
	...
	A2(
		...
		_elm_lang$core$Native_Utils.chr('↓'),
		'dim'));
var _sc_nz$elm_hangman$Test_Reporter_Chalk$todosToChalk = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_sc_nz$elm_hangman$Test_Reporter_Chalk$todoLabelsToChalk(_p5._0),
		_sc_nz$elm_hangman$Test_Reporter_Chalk$todoToChalk(_p5._1));
};
var _sc_nz$elm_hangman$Test_Reporter_Chalk$summarizeTodos = function (todos) {
	var _p6 = A2(_elm_lang$core$List$concatMap, _sc_nz$elm_hangman$Test_Reporter_Chalk$todosToChalk, todos);
	if (_p6.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		return {
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$pluralize = F3(
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$reportBegin = function (_p7) {
	var _p8 = _p7;
	var prefix = A2(
		_elm_lang$core$Basics_ops['++'],
		'\nelm-test\n--------\n\nRunning ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			A3(_sc_nz$elm_hangman$Test_Reporter_Chalk$pluralize, 'test', 'tests', _p8.testCount),
			A2(
				_elm_lang$core$Basics_ops['++'],
	...
	return _elm_lang$core$Maybe$Just(
		_sc_nz$elm_hangman$Test_Reporter_Chalk$chalkWith(
			{
				ctor: '::',
				_0: {
					styles: {ctor: '[]'},
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$indent = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		A2(
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$failureToChalk = function (_p9) {
	var _p10 = _p9;
	var messageChalk = {
		styles: {ctor: '[]'},
		text: A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_sc_nz$elm_hangman$Test_Reporter_Chalk$indent(_p10.message),
				'\n\n'))
	};
	var _p11 = _p10.given;
...
var _sc_nz$elm_hangman$Test_Reporter_Chalk$failuresToChalk = F2(
	function (labels, failures) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_sc_nz$elm_hangman$Test_Reporter_Chalk$failureLabelsToChalk(labels),
			A2(_elm_lang$core$List$concatMap, _sc_nz$elm_hangman$Test_Reporter_Chalk$failureToChalk, failures));
	});
var _sc_nz$elm_hangman$Test_Reporter_Chalk$reportComplete = function (_p12) {
	var _p13 = _p12;
	var _p14 = A2(_elm_lang$core$List$filterMap, _sc_nz$elm_hangman$Test_Reporter_Chalk$getNonTodoFailure, _p13.expectations);
	if (_p14.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		return _elm_lang$core$Maybe$Just(
			_sc_nz$elm_hangman$Test_Reporter_Chalk$chalkWith(
				A2(_sc_nz$elm_hangman$Test_Reporter_Chalk$failuresToChalk, _p13.labels, _p14)));
	}
};
var _sc_nz$elm_hangman$Test_Reporter_Chalk$formatDuration = function (time) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(time),
		' ms');
};
var _sc_nz$elm_hangman$Test_Reporter_Chalk$reportSummary = F3(
	function (duration, autoFail, results) {
		var _p15 = _sc_nz$elm_hangman$Test_Reporter_Chalk$getTodosAndFailures(results);
		...
		var todoStats = function () {
			...
			if (_p19 === 0) {
				...
				return A2(
					_sc_nz$elm_hangman$Test_Reporter_Chalk$stat,
					'Todo:     ',
					_elm_lang$core$Basics$toString(_p19));
			}
		}();
		var individualTodos = (_elm_lang$core$Native_Utils.cmp(nonTodoFailures, 0) > 0) ? {ctor: '[]'} : _sc_nz$elm_hangman$Test_Reporter_Chalk$summarizeTodos(
			_elm_lang$core$List$reverse(todos));
		return _elm_lang$core$Json_Encode$list(
			A2(
				_elm_lang$core$List$map,
				_sc_nz$elm_hangman$Chalk$encode,
				_elm_lang$core$List$concat(
					{
						...
						_1: {
							...
							_0: A2(
								_sc_nz$elm_hangman$Test_Reporter_Chalk$stat,
								'Duration: ',
								_sc_nz$elm_hangman$Test_Reporter_Chalk$formatDuration(duration)),
							_1: {
								ctor: '::',
								_0: A2(
									_sc_nz$elm_hangman$Test_Reporter_Chalk$stat,
...
var _sc_nz$elm_hangman$Test_Reporter_Json$reportSummary = F3(
	function (duration, autoFail, results) {
...
var _sc_nz$elm_hangman$Test_Reporter_Json$encodeFailure = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
...
var _sc_nz$elm_hangman$Test_Reporter_Json$encodeFailures = function (expectations) {
	return _elm_lang$core$Json_Encode$list(
		A2(
			_elm_lang$core$List$filterMap,
			function (_p3) {
				return A2(
					_elm_lang$core$Maybe$map,
					_sc_nz$elm_hangman$Test_Reporter_Json$encodeFailure,
					_elm_community$elm_test$Test_Runner$getFailure(_p3));
			},
			expectations));
};
var _sc_nz$elm_hangman$Test_Reporter_Json$encodeLabels = function (labels) {
	return _elm_lang$core$Json_Encode$list(
		A2(
			_elm_lang$core$List$map,
...
var _sc_nz$elm_hangman$Test_Reporter_Json$getStatus = function (expectations) {
...
var _sc_nz$elm_hangman$Test_Reporter_Json$reportComplete = function (_p5) {
	var _p6 = _p5;
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						...
						_0: 'status',
						_1: _elm_lang$core$Json_Encode$string(
							_sc_nz$elm_hangman$Test_Reporter_Json$getStatus(_p7))
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'labels',
							_1: _sc_nz$elm_hangman$Test_Reporter_Json$encodeLabels(_p6.labels)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'failures',
								_1: _sc_nz$elm_hangman$Test_Reporter_Json$encodeFailures(_p7)
							},
							_1: {
								ctor: '::',
								_0: {
...
var _sc_nz$elm_hangman$Test_Reporter_Json$reportBegin = function (_p8) {
	var _p9 = _p8;
	return _elm_lang$core$Maybe$Just(
		_elm_lang$core$Json_Encode$object(
			{
...
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTime = function (time) {
	return _elm_lang$core$Json_Encode$string(
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Time$inSeconds(time)));
};
var _sc_nz$elm_hangman$Test_Reporter_JUnit$formatClassAndName = function (labels) {
	var _p0 = labels;
	if (_p0.ctor === '::') {
		return {
			ctor: '_Tuple2',
...
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeFailureMessage = function (_p1) {
	var _p2 = _p1;
	return {
		ctor: '::',
		_0: {
...
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTestcaseFailure = function (expectation) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
			_elm_lang$core$Maybe$map,
			_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeFailureMessage,
			_elm_community$elm_test$Test_Runner$getFailure(expectation)));
};
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTest = F2(
	function (_p3, expectation) {
		var _p4 = _p3;
		var _p5 = _sc_nz$elm_hangman$Test_Reporter_JUnit$formatClassAndName(_p4.labels);
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: '@time',
								_1: _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTime(_p4.duration)
							},
							_1: {ctor: '[]'}
						}
					}
				},
				_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTestcaseFailure(expectation)));
	});
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeSuite = F2(
	function (extraFailure, result) {
		var baseExpectations = A2(
			_elm_lang$core$List$map,
			_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTest(result),
			result.expectations);
		...
		if (_p6.ctor === 'Nothing') {
			...
			return A2(
				...
				_elm_lang$core$List$singleton(
					A2(
						_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTest,
						{
							labels: {ctor: '[]'},
							duration: 0,
							expectations: {
...
var _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeSuites = F2(
	function (extraFailure, results) {
		return _elm_lang$core$Json_Encode$list(
			A2(
				_elm_lang$core$List$concatMap,
				_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeSuite(extraFailure),
				results));
	});
var _sc_nz$elm_hangman$Test_Reporter_JUnit$reportSummary = F3(
	function (duration, autoFail, results) {
		var expectations = A2(
			_elm_lang$core$List$concatMap,
			function (_) {
										...
										_1: {
											...
											_1: {
												...
												_0: {
													ctor: '_Tuple2',
													_0: '@time',
													_1: _sc_nz$elm_hangman$Test_Reporter_JUnit$encodeTime(
														A3(
															_elm_lang$core$List$foldl,
															F2(
																function (x, y) {
												...
												_1: {
													...
													_0: {
														ctor: '_Tuple2',
														_0: 'testcase',
														_1: A2(_sc_nz$elm_hangman$Test_Reporter_JUnit$encodeSuites, extraFailure, results)
													},
													_1: {ctor: '[]'}
												}
											}
...
var _sc_nz$elm_hangman$Test_Reporter_JUnit$reportComplete = function (_p7) {
	var _p8 = _p7;
	return _elm_lang$core$Maybe$Nothing;
};
var _sc_nz$elm_hangman$Test_Reporter_JUnit$reportBegin = function (_p9) {
	return _elm_lang$core$Maybe$Nothing;
};

var _sc_nz$elm_hangman$Test_Reporter_Reporter$TestReporter = F4(
	function (a, b, c, d) {
		return {format: a, reportBegin: b, reportComplete: c, reportSummary: d};
	});
var _sc_nz$elm_hangman$Test_Reporter_Reporter$createReporter = function (report) {
	var _p0 = report;
	switch (_p0.ctor) {
		case 'JsonReport':
			return A4(_sc_nz$elm_hangman$Test_Reporter_Reporter$TestReporter, 'JSON', _sc_nz$elm_hangman$Test_Reporter_Json$reportBegin, _sc_nz$elm_hangman$Test_Reporter_Json$reportComplete, _sc_nz$elm_hangman$Test_Reporter_Json$reportSummary);
		case 'ChalkReport':
			return A4(_sc_nz$elm_hangman$Test_Reporter_Reporter$TestReporter, 'CHALK', _sc_nz$elm_hangman$Test_Reporter_Chalk$reportBegin, _sc_nz$elm_hangman$Test_Reporter_Chalk$reportComplete, _sc_nz$elm_hangman$Test_Reporter_Chalk$reportSummary);
		default:
			return A4(_sc_nz$elm_hangman$Test_Reporter_Reporter$TestReporter, 'JUNIT', _sc_nz$elm_hangman$Test_Reporter_JUnit$reportBegin, _sc_nz$elm_hangman$Test_Reporter_JUnit$reportComplete, _sc_nz$elm_hangman$Test_Reporter_JUnit$reportSummary);
	}
};
var _sc_nz$elm_hangman$Test_Reporter_Reporter$JUnitReport = {ctor: 'JUnitReport'};
var _sc_nz$elm_hangman$Test_Reporter_Reporter$JsonReport = {ctor: 'JsonReport'};
var _sc_nz$elm_hangman$Test_Reporter_Reporter$ChalkReport = {ctor: 'ChalkReport'};
var _sc_nz$elm_hangman$Test_Reporter_Reporter$fromString = function (str) {
	var _p1 = _elm_lang$core$String$toLower(str);
	switch (_p1) {
		case 'chalk':
			return _elm_lang$core$Result$Ok(_sc_nz$elm_hangman$Test_Reporter_Reporter$ChalkReport);
		case 'json':
			return _elm_lang$core$Result$Ok(_sc_nz$elm_hangman$Test_Reporter_Reporter$JsonReport);
		case 'junit':
			return _elm_lang$core$Result$Ok(_sc_nz$elm_hangman$Test_Reporter_Reporter$JUnitReport);
		default:
			return _elm_lang$core$Result$Err(
				A2(
					_elm_lang$core$Basics_ops['++'],
...
var _sc_nz$elm_hangman$Test_Runner_Node_App$defaultRunCount = 100;
var _sc_nz$elm_hangman$Test_Runner_Node_App$timeToNumericSeed = function (time) {
	return _elm_lang$core$Tuple$first(
		A2(
			_mgold$elm_random_pcg$Random_Pcg$step,
...
var _sc_nz$elm_hangman$Test_Runner_Node_App$InitArgs = F6(
	function (a, b, c, d, e, f) {
		return {initialSeed: a, fuzzRuns: b, startTime: c, paths: d, runners: e, report: f};
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$RunnerOptions = F4(
	function (a, b, c, d) {
		return {seed: a, runs: b, reporter: c, paths: d};
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$AppOptions = F3(
	function (a, b, c) {
		return {init: a, update: b, subscriptions: c};
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$SubMsg = function (a) {
	return {ctor: 'SubMsg', _0: a};
};
var _sc_nz$elm_hangman$Test_Runner_Node_App$subscriptions = F2(
	function (subs, model) {
		var _p0 = model;
		if (_p0.ctor === 'Uninitialized') {
			...
			return A2(
				...
				_sc_nz$elm_hangman$Test_Runner_Node_App$SubMsg,
				subs(_p0._1));
		}
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$Init = function (a) {
	return {ctor: 'Init', _0: a};
};
var _sc_nz$elm_hangman$Test_Runner_Node_App$Uninitialized = F2(
	function (a, b) {
		return {ctor: 'Uninitialized', _0: a, _1: b};
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$Initialized = F2(
	function (a, b) {
		return {ctor: 'Initialized', _0: a, _1: b};
	});
var _sc_nz$elm_hangman$Test_Runner_Node_App$initOrUpdate = F2(
	function (msg, maybeModel) {
		...
		if (_p1.ctor === 'Uninitialized') {
			...
			if (_p2.ctor === 'Init') {
				...
				var numericSeed = function () {
					...
					if (_p3.ctor === 'Just') {
						...
						return _sc_nz$elm_hangman$Test_Runner_Node_App$timeToNumericSeed(_p5);
					}
				}();
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_sc_nz$elm_hangman$Test_Runner_Node_App$Initialized, _p1._0, subModel),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _sc_nz$elm_hangman$Test_Runner_Node_App$SubMsg, subCmd)
				};
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
			...
			if (_p8.ctor === 'SubMsg') {
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_sc_nz$elm_hangman$Test_Runner_Node_App$Initialized, _p11, newModel),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _sc_nz$elm_hangman$Test_Runner_Node_App$SubMsg, cmd)
				};
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Test.Runner.Node.App',
...
var _sc_nz$elm_hangman$Test_Runner_Node_App$run = F3(
	function (_p12, appOpts, test) {
		...
		var init = function (args) {
			var report = function () {
				...
				if (_p14.ctor === 'Nothing') {
					return _sc_nz$elm_hangman$Test_Reporter_Reporter$ChalkReport;
				} else {
					var _p15 = _sc_nz$elm_hangman$Test_Reporter_Reporter$fromString(_p14._0);
					if (_p15.ctor === 'Ok') {
						return _p15._0;
					} else {
						return _elm_lang$core$Native_Utils.crashCase(
			...
			var cmd = A2(_elm_lang$core$Task$perform, _sc_nz$elm_hangman$Test_Runner_Node_App$Init, _elm_lang$core$Time$now);
			return {
				ctor: '_Tuple2',
				_0: A2(
					_sc_nz$elm_hangman$Test_Runner_Node_App$Uninitialized,
					appOpts.update,
					{
						maybeInitialSeed: _p13.seed,
						report: report,
						runs: A2(_elm_lang$core$Maybe$withDefault, _sc_nz$elm_hangman$Test_Runner_Node_App$defaultRunCount, _p13.runs),
						paths: _p13.paths,
						test: test,
						init: appOpts.init
					}),
		...
		return _elm_lang$core$Platform$programWithFlags(
			{
				init: init,
				update: _sc_nz$elm_hangman$Test_Runner_Node_App$initOrUpdate,
				subscriptions: _sc_nz$elm_hangman$Test_Runner_Node_App$subscriptions(appOpts.subscriptions)
			});
	});

var _sc_nz$elm_hangman$Test_Runner_Node$warn = F2(
	function (str, result) {
		var _p0 = _elm_lang$core$Debug$log(str);
		return result;
	});
var _sc_nz$elm_hangman$Test_Runner_Node$runThunk = _sc_nz$elm_hangman$Native_RunTest.runThunk;
var _sc_nz$elm_hangman$Test_Runner_Node$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {available: a, running: b, queue: c, startTime: d, finishTime: e, completed: f, testReporter: g, autoFail: h};
	});
var _sc_nz$elm_hangman$Test_Runner_Node$Finish = function (a) {
	return {ctor: 'Finish', _0: a};
};
var _sc_nz$elm_hangman$Test_Runner_Node$Complete = F5(
	function (a, b, c, d, e) {
		return {ctor: 'Complete', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _sc_nz$elm_hangman$Test_Runner_Node$Dispatch = function (a) {
	return {ctor: 'Dispatch', _0: a};
};
var _sc_nz$elm_hangman$Test_Runner_Node$dispatch = A2(_elm_lang$core$Task$perform, _sc_nz$elm_hangman$Test_Runner_Node$Dispatch, _elm_lang$core$Time$now);
var _sc_nz$elm_hangman$Test_Runner_Node$update = F3(
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _sc_nz$elm_hangman$Test_Runner_Node$dispatch,
								_1: {ctor: '[]'}
							}
						})
				};
			default:
				...
				if (_p6.ctor === '[]') {
					return {
						ctor: '_Tuple2',
						_0: _p9,
						_1: A2(_elm_lang$core$Task$perform, _sc_nz$elm_hangman$Test_Runner_Node$Finish, _elm_lang$core$Time$now)
					};
				} else {
					var _p8 = _p6._0;
					...
					if (_p7.ctor === 'Nothing') {
						return A2(
							_sc_nz$elm_hangman$Test_Runner_Node$warn,
							A2(
								_elm_lang$core$Basics_ops['++'],
						...
						var expectations = _sc_nz$elm_hangman$Test_Runner_Node$runThunk(_p7._0.run);
						var complete = A4(_sc_nz$elm_hangman$Test_Runner_Node$Complete, _p8, _p7._0.labels, expectations, _p3._0);
						return {
							ctor: '_Tuple2',
							_0: newModel,
...
var _sc_nz$elm_hangman$Test_Runner_Node$init = F2(
	function (emit, _p11) {
		var _p12 = _p11;
		var testReporter = _sc_nz$elm_hangman$Test_Reporter_Reporter$createReporter(_p12.report);
		var _p13 = function () {
...
var _sc_nz$elm_hangman$Test_Runner_Node$runWithOptions = F2(
	function (options, emit) {
		return A2(
			_sc_nz$elm_hangman$Test_Runner_Node_App$run,
			options,
			{
				init: _sc_nz$elm_hangman$Test_Runner_Node$init(emit),
				update: _sc_nz$elm_hangman$Test_Runner_Node$update(emit),
...
var _sc_nz$elm_hangman$Test_Generated_Main6f16e0f74ad6bb984b7fe245e4641b20$emit = _elm_lang$core$Native_Platform.outgoingPort(
	'emit',
	function (v) {
		return [v._0, v._1];
	});
var _sc_nz$elm_hangman$Test_Generated_Main6f16e0f74ad6bb984b7fe245e4641b20$main = A3(
	_sc_nz$elm_hangman$Test_Runner_Node$runWithOptions,
	{
	...
	_sc_nz$elm_hangman$Test_Generated_Main6f16e0f74ad6bb984b7fe245e4641b20$emit,
	_elm_community$elm_test$Test$concat(
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _sc_nz$elm_hangman$ModelTests$gameLost,
					_1: {
						ctor: '::',
						_0: _sc_nz$elm_hangman$ModelTests$gameWon,
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
Elm['Test']['Generated']['Main6f16e0f74ad6bb984b7fe245e4641b20'] = Elm['Test']['Generated']['Main6f16e0f74ad6bb984b7fe245e4641b20'] || {};
if (typeof _sc_nz$elm_hangman$Test_Generated_Main6f16e0f74ad6bb984b7fe245e4641b20$main !== 'undefined') {
    _sc_nz$elm_hangman$Test_Generated_Main6f16e0f74ad6bb984b7fe245e4641b20$main(Elm['Test']['Generated']['Main6f16e0f74ad6bb984b7fe245e4641b20'], 'Test.Generated.Main6f16e0f74ad6bb984b7fe245e4641b20', undefined);
}
